...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\AQL-prediction_project\AQI-prediction-api-master\server'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\AQL-prediction_project\AQI-prediction-api-master\server\Scripts\deactivate.nu'
